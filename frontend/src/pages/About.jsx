    ...
    <div className='mx-0 md:mx-10'>
      ...
      <div className='my-7 md:my-10 flex flex-col items-center lg:flex-row gap-7 md:gap-12'>
        ...
        <div className='flex flex-col justify-center md:text-justify gap-4 md:gap-6 text-sm md:text-base text-gray-600'>
          <p>
            Welcome to MediBridge, your trusted partner in managing your
            healthcare needs conveniently and efficiently. At MediBridge, we
            understand the challenges individuals face when it comes to
            scheduling doctor appointments and managing their health records.
          </p>
          <p>
          MediBridge is committed to excellence in healthcare technology. We
            continuously strive to enhance our platform, integrating the latest
            advancements to improve user experience and deliver superior
            service. Whether you are booking your first appointment or managing
            ongoing care, MediBridge is here to support you every step of the
            way.
          </p>
          ...
          <p>
            Our vision at MediBridge is to create a seamless healthcare
